...
$.fn.dragscrollable = function( options ){
    ...
    var dragscroll= {
        ...
        mouseUpHandler : function(event) { // Stop scrolling
            ...
            if (event.data.preventDefault) {
                console.log(event.data.lastCoord.left == event.data.initCoord.left);
                // Change by Mateus Guerra, based in solution found in stack overflow
                // https://stackoverflow.com/questions/13513077/disable-links-when-clicking-and-dragging-to-scroll-jquery
                // Test if event scroll displacement left or top are unequal in order to prevent click 
                if(event.data.lastCoord.left != event.data.initCoord.left || event.data.lastCoord.top != event.data.initCoord.top ){
                    obj = $(this); 
